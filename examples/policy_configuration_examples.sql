...
-- Row Access Policy with ON clause (using INDIRECTTABLECOLUMN for the column in ON clause)
('3', 'DBCSUDL.CHRS.DL_POSITION_DATA', NULL, 'Y', NULL, 'BUSINESS_UNIT', 'PS_CHRS_BUSINESS_UNIT_POLICY', 'Apply business unit policy on BUSINESS_UNIT column'),
